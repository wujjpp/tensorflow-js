...
if (__BROWSER__) {
  let resizeDetector = require('resize-detector')
  addListener = resizeDetector.addListener
  removeListener = resizeDetector.removeListener
}
...
export default {
  props: {
    options: Object,
    theme: { type: [String, Object], default: () => theme.macarons2 },
    initOptions: Object,
    group: String,
    autoresize: Boolean,
